...
new PlateNode(
  capacitor: Capacitor,
  modelViewTransform: YawPitchModelViewTransform3,
  polarity: typeof CapacitorConstants.POLARITY.POSITIVE,  // pass CapacitorConstants.POLARITY.POSITIVE or .NEGATIVE — these are enum values, not the strings 'POSITIVE'/'NEGATIVE'
